...
<img className="img_set" src="assets/images/images1.gif"/>
	...
	<div class="container">
        ...
        <h3 className="heading_h3 set_head">What are NFTs?</h3>
...
Bitcoin.</p>
<h3 className="heading_h3 set_head">What is Ethereum?</h3>
...
<h3 className="heading_h3 set_head">What Wallets are Supported?</h3>
...
<h3 className="heading_h3 set_head">Where does my NFT go after I purchase a Pakalol Buzz?
</h3>
...
<h3 className="heading_h3 set_head">Sounds awesome - How do I get involved?</h3>
...
<h3 className="heading_h3 set_head">Are Pakalolo a good investment?</h3>
...
<h3 className="heading_h3 set_head">Where did PakaloloBuzz come from?</h3>
        <p className="para_p">Our team comes from a group of business Men and Women, that have a number business under their belt. We are looking
to bring a different way for people to make money in the NFT Web3 marketplace. We are partnering on this project with —-
